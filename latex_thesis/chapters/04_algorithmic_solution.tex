...
We employ a \textbf{Soft-Voting} mechanism using a 2D \textbf{Hann Window} (Squared Sine), which guarantees higher-order continuity.
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Low Entropy ($H \to 0$):} The model is confident (e.g., center of a deep lake).
        \item \textbf{High Entropy ($H \to \log_2(C)$):} The model is uniformly confused (e.g., cloud edges, mixed pixels).
    \end{itemize}
\end{itemize}
